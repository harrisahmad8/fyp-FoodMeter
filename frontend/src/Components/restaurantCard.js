...
export const RestaurantCard = ({data}) => {
  ...
  if (!Array.isArray(data)) {
    ...
    return (
      <div className="p-5 items-center flex justify-center grid grid-cols-1 grid-rows-3 gap-20 shadow-md bg-whitesmoke m-auto w-100 h-70 rounded-2xl
      ">
        {data.map((data, index) => (
        <div key={index}>
          <button onClick={() =>
         ...
         <div class="max-w-sm rounded overflow-hidden shadow-lg m-auto mt-10 h-100 w-100">
         <img class="w-full" src={data.logopath} alt="Sunset in the mountains"/>
         <div class="px-6 py-4">
